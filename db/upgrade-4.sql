...
(
	...
	SELECT friend_claim.id AS friend_claim_id, generation, root, forward1, forward2, active
	FROM put_tree_orig
	JOIN friend_claim ON put_tree_orig.user = friend_claim.user AND 
			put_tree_orig.friend_id = friend_claim.friend_id;
